...
@Getter
@Module.Info(name = "Vanilla Tweaks", bind = Keyboard.KEY_F, description = "Basic Vanilla changes.", category = Category.Player)
public class VanillaTweaks extends Module {
    private final Setting<Double> entityCullingDistance = Setting.create(setting -> setting.setValues("Culling Chunks", 4D, 1D, 64D, 1D));
